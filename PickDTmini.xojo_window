#tag Window
Begin ContainerControl PickDTmini
   AllowAutoDeactivate=   True
   AllowFocus      =   False
   AllowFocusRing  =   False
   AllowTabs       =   True
   Backdrop        =   0
   BackgroundColor =   &c60606000
   DoubleBuffer    =   False
   Enabled         =   True
...
#tag Events DayButton
	#tag Event
		Sub Action(index as Integer)
		  ...
		  // Ist ein Button des Nachfolgemonats angeklickt worden? (Fontgröße 8, index größer 30)
		  If DayButton(index).FontSize = 8 And index > 30 Then
		  ...
		  // Ist ein Button des Vormonats angeklickt worden? (Fontgröße 8, index kleiner 7)
		  If DayButton(index).FontSize = 8 And index < 7 Then
